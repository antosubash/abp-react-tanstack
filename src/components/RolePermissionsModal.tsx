...
import type { PermissionGrantInfoDto } from "@/client/types.gen";
...
export function RolePermissionsModal() {
	...
	}, [permissionsResponse, role?.id, setAllPermissions, setRolePermissions]);
	...
	// Group filtered permissions using API groups
